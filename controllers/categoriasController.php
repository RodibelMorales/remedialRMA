...
class categoriasController extends AppController
{
	...
	public function edit($id = NULL){
		if ($_POST) {
			if ($this->update("categorias", $_POST)) {
			...
			$this->_view->categoria = $this->find("categorias", "first", array("conditions" => "id=".$id));
	...
	public function delete($id = NULL){
		$conditions = "id=".$id;
		if ($this->delete("categorias", $conditions)) {
			$this->redirect(array("controller" => "categorias", "action" => "index"));
		}
	}
}
